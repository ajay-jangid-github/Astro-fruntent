...
const DashboardOverview = () => {
  ...
  const fetchStats = async () => {
    try {
      const { data } = await axios.get('https://astrology-backend-1.onrender.com/api/admin/stats', {
      ...
      try {
        const [productsRes, blogsRes] = await Promise.all([
          axios.get('https://astrology-backend-1.onrender.com/api/product'),
          axios.get('https://astrology-backend-1.onrender.com/api/blog')
        ]);
        setStats({
          users: 0,
